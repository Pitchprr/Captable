...
export const RoundManager: React.FC<RoundManagerProps> = ({ capTable, onUpdate, onCapTableUpdate }) => {
    ...
    const saveNewInvestor = (roundId: string) => {
        ...
        let newShareholders = [...capTable.shareholders];
        ...
        if (existingInvIndex >= 0) {
            ...
            const currentInv = newInvestments[existingInvIndex];
            newInvestments[existingInvIndex] = {
                ...currentInv,
                amount: currentInv.amount + newInvestorAmount
            };
        } else {
            // Add new investment
            newInvestments.push({
        ...
        const newRounds = capTable.rounds.map(r =>
            r.id === roundId ? { ...r, investments: newInvestments } : r
        );
